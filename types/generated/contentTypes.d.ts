...
export interface ApiEoCalendarEventEoCalendarEvent
  ...
  info: {
    displayName: 'EO-calendar-event';
    pluralName: 'eo-calendar-events';
    singularName: 'eo-calendar-event';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::eo-calendar-event.eo-calendar-event'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiMundial2026SorteoMundial2026Sorteo
  ...
  info: {
    displayName: 'mundial-2026-sorteo';
    pluralName: 'mundial-2026-sorteos';
    singularName: 'mundial-2026-sorteo';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Grupo: Schema.Attribute.Component<'grupo.grupos-mundial-sorteo', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::mundial-2026-sorteo.mundial-2026-sorteo'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
